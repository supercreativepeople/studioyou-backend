...
STEP_MAP = {
    ...
    "fund": [
        {"num": 1, "section": "Capital Strategy", "title": "Target Budget",
         "condition": "Creator has stated a specific dollar amount or budget range for the project."},
        {"num": 2, "section": "Capital Strategy", "title": "Funding Strategy",
         "condition": "Creator has named at least one funding source — self-funded, investors, brand sponsorship, crowdfunding, or grants."},
        {"num": 3, "section": "Capital Strategy", "title": "Outreach & Pitching",
         "condition": "Creator has named at least one specific target to pitch and described how outreach will be tracked."},
    ],
    "cast": [
        {"num": 1, "section": "Talent", "title": "Role Specs",
         "condition": "Creator has listed the roles that need to be filled for the project."},
        {"num": 2, "section": "Talent", "title": "Audition Management",
         "condition": "Creator has described how audition submissions will be tracked and reviewed."},
        {"num": 3, "section": "Talent", "title": "Booking",
         "condition": "Creator confirms an offer is out or a deal has been signed for at least one role."},
    ],
    "plan": [
        {"num": 1, "section": "Pre-Production", "title": "Schedule & Timeline",
         "condition": "Creator has stated shoot dates and an estimated duration or production timeline."},
        {"num": 2, "section": "Pre-Production", "title": "Crew & Staffing",
         "condition": "Creator has named who is working behind the scenes — even if a one-person crew."},
        {"num": 3, "section": "Pre-Production", "title": "Gear & Equipment",
         "condition": "Creator has listed the specific cameras, lighting, audio, or compute gear needed for the project."},
        {"num": 4, "section": "Pre-Production", "title": "Logistics & Permitting",
         "condition": "Creator confirms locations are identified and any required permits or insurance are addressed."},
    ],
    "produce": [
        {"num": 1, "section": "Production", "title": "Daily Prep & Call Sheets",
         "condition": "Creator confirms cast and crew have call times and know where to be for the production day."},
        {"num": 2, "section": "Production", "title": "Capture & Execution",
         "condition": "Creator confirms that recording or generation of assets has begun or is complete."},
        {"num": 3, "section": "Production", "title": "Data Management",
         "condition": "Creator confirms files are backed up and organized in a named storage system or workflow."},
    ],
    "post": [
        {"num": 1, "section": "Post Production", "title": "Editorial",
         "condition": "Creator has described the edit approach and confirmed a cut exists — rough or fine."},
        {"num": 2, "section": "Post Production", "title": "Visual Polish",
         "condition": "Creator confirms color grade or visual treatment is applied and matches the intended look."},
        {"num": 3, "section": "Post Production", "title": "Audio Post",
         "condition": "Creator confirms dialogue, music, and sound effects are mixed and the audio sounds professional."},
        {"num": 4, "section": "Post Production", "title": "Mastering & Export",
         "condition": "Creator confirms the final file is exported in the format required by the target platform."},
    ],
    "brand": [
        {"num": 1, "section": "Identity", "title": "Visual Identity",
         "condition": "Creator has described or produced logos, typography, or cover art for public representation of the project."},
        {"num": 2, "section": "Identity", "title": "Positioning",
         "condition": "Creator has stated how they describe the project publicly — a tagline, press description, or pitch phrase."},
    ],
    "market": [
        {"num": 1, "section": "Campaign", "title": "Campaign Strategy",
         "condition": "Creator has outlined a promotional approach with at least one tactic named — trailer, social posts, or advertising."},
        {"num": 2, "section": "Campaign", "title": "Asset Creation",
         "condition": "Creator has identified the specific promotional materials needed and at least one asset is in production or complete."},
    ],
    "monetize": [
        {"num": 1, "section": "Revenue", "title": "Revenue Streams",
         "condition": "Creator has named at least one specific way the project generates income."},
        {"num": 2, "section": "Revenue", "title": "Tracking & Analytics",
         "condition": "Creator has named a method or platform for monitoring revenue and audience performance."},
    ],
    "distribute": [
        {"num": 1, "section": "Distribution", "title": "Platform Strategy",
         "condition": "Creator has named at least one platform where the project will be published or distributed."},
        {"num": 2, "section": "Distribution", "title": "Asset Delivery",
         "condition": "Creator confirms master files, thumbnails, and descriptions are being prepared or uploaded to the target platform."},
    ],
    "licensing": [
        {"num": 1, "section": "Rights & Clearance", "title": "Clearances & Rights",
         "condition": "Creator confirms any third-party music, footage, or assets are cleared, or identifies specifically what still needs clearance."},
        {"num": 2, "section": "Rights & Clearance", "title": "Releases",
         "condition": "Creator confirms signed releases are obtained from all individuals and locations captured during production."},
    ],
}
